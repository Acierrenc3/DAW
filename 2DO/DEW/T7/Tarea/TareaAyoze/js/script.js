...
function borrado() {
  ...
  if (
    confirm(
      "¿Seguro que desea borrar el registro de " + miNombre[miReg],
      "titulo"
    )
  ) {
...
function noMas(miTit, miMensa) {
  $("#titulo")
    .fadeOut(1)
    .html("Lector de Titulares RSS con AJAX y jQuery >>> " + miTit)
    .fadeIn(1000);
  $("#noticias")
    .fadeOut(1)
    .html("<h1 style='color:red;'>" + miMensa + "</h1>")
    .fadeIn(1000);
}
